...
func ensureExternalRule(client *gophercloud.ServiceClient, port int, protocol string, lbSecGroup string, sourceRange string) error {
	...
	err = rules.List(client, lbSecGroupRuleListOpts).EachPage(func(page pagination.Page) (bool, error) {
...
func (lbaas *LbaasV2) EnsureLoadBalancerSecurityGroups(clusterName string, service *v1.Service, nodeNames []string, LoadBalancerExists bool) error {
